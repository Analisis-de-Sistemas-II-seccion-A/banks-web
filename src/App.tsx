      ...
      <div className="App">
        <BrowserRouter>
          ...
          <div className={isLargeScreen ? 'content-container' : ''}>
            <Routes>
              <Route path={`${PATH}/`} element={<AccountsList theme={theme} />} />
              <Route path={`${PATH}/reports`} element={<ReportGeneration theme={theme} />} />
              <Route path={`${PATH}/statistics`} element={<Statistics theme={theme} />} />
              <Route path={`${PATH}/accounts/:account/detail`} element={<AccountDetail theme={theme} />} />
              <Route path={`${PATH}/transactions`} element={<Transactions theme={theme} />} />
              <Route path={`${PATH}/reports/detail`} element={<ReportsDetail />} />
              <Route path={`${PATH}/reconciliation`} element={<BankReconciliation theme={theme} />} />
              <Route path={`${PATH}/reconciliation/detail`} element={<ReconciliationDetail theme={theme} />} />
              <Route path={`${PATH}/accounts/:type`} element={<CreateOrUpdateAccount theme={theme} />} />
              <Route path={`${PATH}/transfer`} element={<Transfer />} />
              <Route path={`${PATH}/transaction/:type`} element={<ExecuteTransaction />} />
            </Routes>
          </div>
          <Hidden lgUp>
            <AccountNavigation />
